      ...
      <div className="max-w-7xl bg-gradient-to-b from-transparent via-white/20 to-transparent   mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="max-w-max mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-white text-shadow-[7px_5px_10px_#000000] backdrop-opacity-20 mb-4">
              How it works
            </h2>
          </div>

          <p className="text-lg text-gray-600 font-semibold text-shadow-lg max-w-2xl mx-auto">
            Start your journey to better mental health in three simple steps. It
            takes less than 5 minutes a day.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-12 *:bg-white/80 *:rounded-xl *:p-4">
        <motion.div
